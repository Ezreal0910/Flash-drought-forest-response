...
% 定义文件夹路径
meteoro_data_path = 'N:\GZW\站点数据_1217\鼎湖山\ecodb_31253.11.sciencedb.1009\30分钟气象数据';
flux_data_path = 'N:\GZW\站点数据_1217\鼎湖山\ecodb_31253.11.sciencedb.1009\30分钟通量数据';

output_path = 'N:\GZW\站点数据_1217\鼎湖山';
...
for i = 2:length(meteoro_files)
    ...
    full_path = fullfile(save_path, sprintf('%d_output_data2.txt', Year(1)));
