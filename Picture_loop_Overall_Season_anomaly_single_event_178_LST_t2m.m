...
% 指定路径
path = 'E:\Data\站点数据_1217\千烟洲\FD_178_4';
...
for i = 1:length(selected_files_all)
    ...
    for j = 1:length(current_files)
        ...
        switch fourth_word
            case 'LST'
                data_LST = readmatrix("E:\Data\站点数据_1217\千烟洲\FD_178_4\FD_178_LST_mean.csv");
                data_t2m = readmatrix("E:\Data\站点数据_1217\千烟洲\FD_178_4\FD_178_t2m_mean.csv");
                ...
                % 构建新的输出文件名
                output_file = sprintf('%s_%s_%s_LST_t2m_2.svg', words{1}, words{2}, site_name);
